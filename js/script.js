...
function validarFormulario(event) {
    // Prevenir o envio do formulário caso algum campo esteja vazio
    let campos = [
        "nome", "cpf", "fone", "email", "senha", 
        "endereco", "cep", "cidade", "estado", "profissao"
    ];
    ...
    for (let i = 0; i < campos.length; i++) {
        ...
        // Verifica se o campo está vazio (sem usar trim())
        if (campo.value === "") { // Se o campo estiver completamente vazio
            alert(`Por favor, preencha o campo ${campo.placeholder}.`);
            campo.style.borderColor = "#f44336"; // Destaca o campo em vermelho
            campo.style.boxShadow = "0 0 8px rgba(244, 67, 54, 0.7)";
            event.preventDefault(); // Impede o envio do formulário
            return false;
        } else {
            // Limpa os estilos se o campo estiver preenchido
...
// Adicionar o evento de validação antes de enviar o formulário
